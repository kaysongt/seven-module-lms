...
export default function ChildrenPage({ context }: { context: PublicContext }) {
  return (
    <main className="overflow-hidden">
      <PublicNav context={context} />

      <section id="main-content" className="border-b border-[var(--line)] bg-[var(--forest-deep)] py-20 text-white md:py-28">
      ...
      <section className="bg-[var(--paper-light)] py-24 md:py-32">
        <div className="page-shell grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <Link href={localHref(context, "contact")} className="button-quiet mt-6 !px-0">
